---
title: Theming
description: This guide covers the key differences Zalify UI introduces to theming.
metaDescription: Customize your Zalify UI theme with Panda CSS. Learn about sizing, variants, and our systematic design approach for consistent UIs.
category: getting-started
---

Zalify UI extends the default [Panda Preset](https://www.npmjs.com/package/@pandacss/preset-panda) with a minimal, systematic design approach. It introduces key adjustments to component sizing and variants to ensure alignment and visual consistency across your UI.
...
The biggest change Zalify UI introduces is its color system. Instead of the `50–950` scale used in Panda CSS, Zalify UI is built on [Radix Colors](https://www.radix-ui.com/colors). Each color comes with 12 shades per mode (light and dark), for a total of 24 shades. This provides finer control and greater flexibility than the traditional 11-shade scale.
...
Zalify UI is built around the concept of one accent color and one gray color. When initializing your project, you'll choose which combination works best for you.
