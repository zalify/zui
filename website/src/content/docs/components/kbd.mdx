...
metaDescription: Kbd component for React displaying keyboard shortcuts and key combinations. Show keyboard input with proper semantic markup and styling.
category: typography
---
