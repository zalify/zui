...
metaDescription: Pagination component for React enabling navigation through multiple content pages. Accessible page controls with customizable appearance.
category: navigation
links:
