...
metaDescription: Hover Card component for React showing rich content on hover interactions. Display previews, tooltips, and contextual information.
category: overlays
links:
...
```tsx
import { HoverCard } from '@zalify-ui/react'
```
