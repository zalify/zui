...
metaDescription: Tags Input component for React adding and removing multiple tags with keyboard navigation and accessible form controls.
category: forms
links:
...
```tsx
import { TagsInput } from '@zalify-ui/react'
```
