...
metaDescription: Dialog modal component for React displaying important content requiring user interaction. Accessible, customizable, and supports various sizes.
category: overlays
links:
...
```tsx
import { Dialog } from '@zalify-ui/react'
```
