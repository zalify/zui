...
metaDescription: Segment Group component for React creating segmented controls for single selection. Build iOS-style segment controls with smooth transitions.
category: forms
links:
