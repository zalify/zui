...
metaDescription: Number Input component for React with stepper controls for entering numeric values. Support for min/max limits, decimal precision, and formatting.
category: forms
links:
