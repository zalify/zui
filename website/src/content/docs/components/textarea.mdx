...
metaDescription: Textarea component for React for entering multi-line text input with auto-resize support. Build accessible forms with customizable text areas.
category: forms
---
