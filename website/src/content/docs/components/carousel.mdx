...
metaDescription: Interactive carousel for React with smooth transitions, touch support, and rotating slideshows with full accessibility.
category: disclosure
links:
...
```tsx
import { Carousel } from '@zalify-ui/react'
```
