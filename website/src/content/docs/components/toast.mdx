...
metaDescription: Toast notification component for React displaying temporary messages with customizable positioning. Show success, error, and info messages.
category: feedback
links:
...
```tsx
import { Toaster, toaster } from "@zalify-ui/react"
```
