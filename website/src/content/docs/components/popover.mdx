...
metaDescription: Popover component for React displaying contextual information in floating overlays. Flexible positioning and trigger options for rich interactions.
category: overlays
links:
...
```tsx
import { Popover } from '@zalify-ui/react'
```
