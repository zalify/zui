...
metaDescription: Tooltip component for React displaying contextual information on hover or focus. Create accessible tooltips with customizable positioning.
category: overlays
links:
...
```tsx
import { Tooltip } from '@zalify-ui/react'
```
