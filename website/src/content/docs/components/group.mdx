...
metaDescription: Group layout component for React visually grouping related elements together. Create cohesive UI sections with flexible spacing and alignment.
category: layout
---
...
```tsx
import { Group } from '@zalify-ui/react'
```
